...
//import { cache, getTableAndVersion } from "../src/database/query-decorator";
...
export default class TestDatabase {
    ...
    // @GetMapping("/db/check-sql")
    // async checkSql(req, res) {
    //     const sql = 'Insert into `user` (id, name) values (#{id}, #{name})';
    //     const [tableName, tableVersion] = getTableAndVersion(sql);
    //     res.send(tableName);
    // }
